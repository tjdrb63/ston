    ...
    <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
        <div className="w-full md:w-1/2">
            ...
            <div className="mb-10 md:mb-20 text-gray-600 font-light">
                <h1 className="font-black  text-3xl lg:text-5xl text-indigo-700 mb-10">404 NotFound</h1>
                <p>찾고 계시는 어플리케이션이 없어진 것 같네요.</p>
                <p>홈으로 돌아가서 다시 찾아 보세요.</p>
            </div>
            <div className="mb-20 md:mb-0">
                <Link  to="/">
                  <button className="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-blue-500 hover:text-blue-600">홈으로 돌아가기</button></Link>
            </div>
        </div>
